...
namespace AlibabaCloud.OSS.V2.Internal {
    ...
    public class WrapperStream : Stream
    {
        ...
        public WrapperStream(Stream baseStream) => BaseStream = baseStream;
        ...
        /// <summary>
        /// Gets a value indicating whether the current stream supports timeout.
        /// True if the stream supports timeout; otherwise, false.
        /// </summary>
